...
{
    return [
        ['id' => 1,'sn' => 1, 'assignment_type' => 'year_end_account', 'title' => 'Previous year Final account and Trial balance'],
        ['id' => 2,'sn' => 2, 'assignment_type' => 'year_end_account', 'title' => 'Previous year working paper'],
        ['id' => 3,'sn' => 3, 'assignment_type' => 'year_end_account', 'title' => 'Sales details'],
        ['id' => 4, 'sn' => 4,'assignment_type' => 'year_end_account', 'title' => 'Purchase / expenses details'],
        ['id' => 5,'sn' => 5, 'assignment_type' => 'year_end_account', 'title' => 'Bank account statements'],
        ['id' => 6, 'sn' => 6,'assignment_type' => 'year_end_account', 'title' => 'Credit card statement'],
        ['id' => 7, 'sn' => 7,'assignment_type' => 'year_end_account', 'title' => 'Loan / HP statements'],
        ['id' => 8, 'sn' => 8,'assignment_type' => 'year_end_account', 'title' => 'Payroll / CIS records'],
        ['id' => 9, 'sn' => 9,'assignment_type' => 'year_end_account', 'title' => 'Expenses re-imbursement details'],
        ['id' => 10,'sn' => 10, 'assignment_type' => 'year_end_account', 'title' => 'Client cashbook'],
        ['id' => 11,'sn' => 11, 'assignment_type' => 'year_end_account', 'title' => 'Others'],
        ['id' => 12, 'sn' => 12,'assignment_type' => 'year_end_account', 'title' => 'Any key events in the year'],
        ['id' => 13,'sn' => 13, 'assignment_type' => 'year_end_account', 'title' => 'Closing stock value'],
        ['id' => 14, 'sn' => 14,'assignment_type' => 'year_end_account', 'title' => 'VAT Scheme'],
        ['id' => 15, 'sn' => 15,'assignment_type' => 'year_end_account', 'title' => 'VAT Computation Method'],
        ['id' => 16, 'sn' => 16,'assignment_type' => 'year_end_account', 'title' => 'VAT Returns and Working'],
