        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12 loginForm">
                <div class="card p-4">
                    ...
                    <form id="loginForm" method="post" action="<?php echo base_url('ClientsOTPVerification');?>">
                        ...
                        <button type="submit" class="mt-3 btn btn-purple w-100">Log in</button>

                        <div class="mb-3 mt-3 text-start">
                            <a href="<?php echo base_url('ClientForgetPassword');?>" class="text-blue">Forgot password?</a>
                        </div>
                    </form>
                </div>
            </div>
