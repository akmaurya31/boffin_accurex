        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12 loginForm">
                <div class="card p-4">
                    ...
                    <form id="loginForm" method="post" action="<?php echo base_url('ClientDashboard');?>">
                        <!-- <h4>Set New Password</h4> -->
                        <div class="mb-2 text-start">
                            <input type="password" class="form-control" placeholder="Enter OTP" name="password" id="password" required>
                        </div>
                        <button type="submit" class="mt-2 btn btn-purple w-100">Verify OTP</button>
