...
<head>
    ...
    <title>Accurex Accounting | <?php echo $page;?></title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/plugins/summernote/dist/summernote-bs4.css">
